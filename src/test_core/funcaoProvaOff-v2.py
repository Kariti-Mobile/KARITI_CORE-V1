...
def gerar_prova(arquivo_csv, pasta_output):
    ...
    try:
        ...
        for linha in dados:
            ...
            #Desenha linha e
            img = cv2.line(img,(80,270),(largura-160,270),(0,0,0),1)
            #Segunda linha
            ...
            #print(qr_code.shape[0])
            x_start = 25
            y_start = largura - qr_code.shape[0] - 50
            
            # Coordenadas de fim
            x_end = x_start + qr_code.shape[0]
            y_end = y_start + qr_code.shape[1]

            # Posicionando o QR code na imagem
            img[x_start:x_end, y_start:y_end] = qr_code
            ...
            # bolinha esquerda superior
            #cv2.circle(img, (30, 560), 20, (0, 0, 0), 8)
            #cv2.circle(img, (30, 560), 8, (0, 0, 0), -1)
            #cv2.circle(img, (55, 500), 25, (0, 0, 0), 8)
            #cv2.circle(img, (55, 500), 10, (0, 0, 0), -1)
            #cv2.circle(img, (30, 30), 25, (0, 0, 0), 8)
            #cv2.circle(img, (30, 30), 10, (0, 0, 0), -1)
            cv2.circle(img, (85, 625), 25, (0, 0, 0), 8)
            cv2.circle(img, (85, 625), 10, (0, 0, 0), -1)
            
            # bolinha direita superior
            #cv2.circle(img, (largura-30, 560), 20, (0, 0, 0), 8)
            #cv2.circle(img, (largura-30, 560), 8, (0, 0, 0), -1)
            #cv2.circle(img, (largura-30, 500), 25, (0, 0, 0), 8)
            #cv2.circle(img, (largura-30, 500), 10, (0, 0, 0), -1)
            #cv2.circle(img, (largura-30, 30), 25, (0, 0, 0), 8)
            #cv2.circle(img, (largura-30, 30), 10, (0, 0, 0), -1)
            cv2.circle(img, (largura-85, 625), 25, (0, 0, 0), 8)
            cv2.circle(img, (largura-85, 625), 10, (0, 0, 0), -1)
            
            
            
            # bolinha esquerda inferior
            #cv2.circle(img, (30, altura-25), 20, (0, 0, 0), 8)
            #cv2.circle(img, (30, altura-25), 8, (0, 0, 0), -1)
            #cv2.circle(img, (30, altura-30), 25, (0, 0, 0), 8)
            #cv2.circle(img, (30, altura-30), 10, (0, 0, 0), -1)
            cv2.circle(img, (85, altura-115), 25, (0, 0, 0), 8)
            cv2.circle(img, (85, altura-115), 10, (0, 0, 0), -1)

            # bolinha direita inferior
            #cv2.circle(img, (largura-30, altura-25), 20, (0, 0, 0), 8)
            #cv2.circle(img, (largura-30, altura-25), 8, (0, 0, 0), -1)
            #cv2.circle(img, (largura-30, altura-30), 25, (0, 0, 0), 8)
            #cv2.circle(img, (largura-30, altura-30), 10, (0, 0, 0), -1)
            cv2.circle(img, (largura-85, altura-115), 25, (0, 0, 0), 8)
            cv2.circle(img, (largura-85, altura-115), 10, (0, 0, 0), -1)

            #cv2.circle(img, (x, y), 60, (0, 0, 0), 24) # 10, 15 e 20

            #Valors originais dos topos dos triângulos (último campo, posição x): 40,largura-70, 40,
            #Cria marcadores triângulo
            '''
            t1 = np.array([[70,640],[100,640],[70,610]], np.int32)
            t2 = np.array([[largura-100,640],[largura-70,640],[largura-100,610]], np.int32)
            t3 = np.array([[70,altura-100],[100,altura-100],[70,altura-130]], np.int32)
            t4 = np.array([[largura-100,altura-100],[largura-70,altura-100],[largura-100,altura-130]], np.int32)
            t = [t1, t2, t3, t4]
